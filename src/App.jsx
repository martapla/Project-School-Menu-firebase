...
function App() {
  const {loading, error, filterMeals, handleFilter, handleSearch, 
    handleSort, addNewMeal,setNewMealName,setNewMealDescription,
    setNewMealCategory,newMealName,newMealDescription,newMealCategory,
    handleEdit,handleDelete,weeklyPlan,addMealToWeeklyPlan,
    removeWeeklyPlan} = useFireBaseFetch()
  ...
  return (
    <>
      ...
      <WeeklyPlan 
        ...
        removeWeeklyPlan={removeWeeklyPlan}
      />
    </>
  )
}
